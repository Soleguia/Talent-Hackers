...
### Paso 3:
La aplicación pasa a tener dos áreas:
(A) una lista de razas de gato 
(B) un área de detalle de raza. 
La aplicación debe mostrar al menos 2 razas. 
En el detalle de gato se debe mostrar foto y número de clicks (sobre la foto).
